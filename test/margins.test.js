...
describe('Margins', () => {
  describe('Margins', () => {
    test('should add margin style', () => {
      ...
      expect(document.getElementById('the-book--style').textContent)
        .toBe('.the-book--margins--side-left{width:150mm;height:237mm;margin:30mm}')
    })
  })
  ...
  describe('update', () => {
    test('should update margin style', () => {
      ...
      expect(document.getElementById('the-book--style').textContent)
        .toBe('.the-book--margins--side-left{width:180mm;height:227mm;margin:40mm 20mm 30mm 10mm}')
    })
  })
})
